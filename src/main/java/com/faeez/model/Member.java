...
public class Member {
	...
	private String city;
	private Date birth; // used. ui memmber has day, month and year as ints.
						// This date is calculated from that.
	private String sex;
	...
	private String hobbies_interests_activities; // future
	...
	// private String month_name; // not needed.. Remove
	...
	/*
	 * public int getAge() { return calculateAgeInYears(); }
	 */
	 ...
	 * 
	 * 
	 * public void setLanguages(String[] languages) { this.languages =
	 * languages; }
	 */
	 ...
	 * 
	 * Date birth2 = getBirth(); LocalDate birthdate = new LocalDate (birth2);
	 * LocalDate now = new LocalDate(); //Today's date Period period = new
	 * Period(birthdate, now, PeriodType.yearMonthDay()); return
	 * period.getYears(); // if(getYear()==0) return 0;
	 * 
	 * }
	 */
	public Long getId() {
	...
	public void setHobbies_interests_activities(
			String hobbies_interests_activities) {
