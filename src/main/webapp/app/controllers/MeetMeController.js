(function() {
	spaApp.controller('MeetMeController', function($scope, $http, $location, $route, userService, auth, ngTableParams, $filter) {
		...
		$scope.init = function() {
			...
			var url = REST_BASE + 'getWhoWannaMeetMe/' + $scope.auth.profile.identities[0].user_id;
