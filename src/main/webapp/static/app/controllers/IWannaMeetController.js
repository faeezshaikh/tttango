(function() {
	spaApp.controller('IWannaMeetController', function($scope, $http, $location, $route, userService, auth, ngTableParams, $filter) {
		...
		$scope.init = function() {
			...
			var url = REST_BASE + 'getWhoIWannaMeet/' + $scope.auth.profile.identities[0].user_id;
